		...
		yunxing.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (comboBox.getSelectedItem().equals("FIFO")) {
					...
					// 显示缺页率
					FIFOrate.setText(String.valueOf(1.0-(double)(FIFOhit) / 128));
					...
					JFrame FIFO = new JFrame("FIFO算法结果        缺页率：" + (1.0-(double)(FIFOhit) / 128));
				...
				// LRU算法
					...
					// 显示缺页率
					LRUrate.setText(String.valueOf(1.0-(double) LRUhit / 128));
					...
					JFrame LRU = new JFrame("LRU算法结果        缺页率：" + (1.0-(double) LRUhit / 128));
				...
				// OPT算法
					...
					// 显示命中率
					OPTrate.setText(String.valueOf((double)(1.0-(double) OPThit / 128)));
					...
					JFrame OPT = new JFrame("OPT算法结果        缺页率：" + (double)(1.0-(double) OPThit / 128));
